...
defaultproperties
{
    /****************************
	  ...
	  ***************************/
      ...
      JNAHeadgear(5)=(HeadgearMeshes=(SkeletalMesh'SM_CHR_JNA_Headgear.Mesh.JNA_Headgear_M59-85_Salad'),HeadgearMICs=(2,3),HeadgearSocket=helmet,bIsHelmet=1,ThumbnailImage=Texture2D'VN_UI_Textures_Character.Headgear.Headgear_US_Standard'))
    //   JNAHeadgear(5)=(HeadgearMeshes=(SkeletalMesh'SM_CHR_JNA_Headgear.Mesh.JNA_Headgear_M59-85MOL'),HeadgearSocket=helmet,bIsHelmet=1,ThumbnailImage=Texture2D'VN_UI_Textures_Character.Headgear.Headgear_US_Standard'))
      ...
      JNAHeadgearMICs(2)=(HeadgearMICTemplate=MaterialInstanceConstant'SM_CHR_JNA_Headgear.Materials.M_JNA_Headgear_Salad_INST',ThumbnailImage=Texture2D'VN_UI_Textures_Character.HeadgearMats.HeadgearMat_US_Leaf')
      JNAHeadgearMICs(3)=(HeadgearMICTemplate=MaterialInstanceConstant'SM_CHR_JNA_Headgear.Materials.M_JNA_Headgear_Salad2_INST',ThumbnailImage=Texture2D'VN_UI_Textures_Character.HeadgearMats.HeadgearMat_US_Cloud')
      ...
      SerbianHeads(2)=(HeadMesh=SkeletalMesh'CHR_VN_US_Heads.Mesh.US_Head6_Mesh',HeadMICTemplates=(MaterialInstanceConstant'CHR_VN_US_Heads.Materials.M_US_Head_06_Long_INST',MaterialInstanceConstant'CHR_VN_US_Heads.Materials.M_US_Head_06_Rolled_INST',MaterialInstanceConstant'CHR_VN_US_Heads.Materials.M_US_Head_06_Pants_Torn_INST'),SkinToneID=0,HairColours=15,ThumbnailImage=Texture2D'VN_UI_Textures_Character.Heads.Head_US_06')
