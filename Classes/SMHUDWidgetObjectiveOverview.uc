...
defaultproperties {
	NorthIcons(0)={(ObjIconRed = Texture2D'VN_UI_Textures.OverheadMap.ui_overheadmap_icons_NVA_red',
        ...
        SouthIcons(0)={(ObjIconRed = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_red',
                        ...
                        ObjBorder = Texture2D'SM_UI.HUD.CaptureBar.ui_hud_obj_ZNG_border',
                    
                        HomeObjIconRed = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_home_red_red',
                        HomeObjIconBlue = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_home_blue_blue',
                        HomeObjEnemyHeldIconRed = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_home_blue_red',
                        HomeObjEnemyHeldIconBlue = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_home_red_blue',
                        HomeObjNeutralRed = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_home_red_white',
                        HomeObjNeutralBlue = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_home_blue_white',
                    
                        CappingObjBorderRed = Texture2D'SM_UI.HUD.CaptureBar.ui_hud_obj_ZNG_border_glow_red',
                        CappingObjBorderBlue = Texture2D'SM_UI.HUD.CaptureBar.ui_hud_obj_ZNG_border_glow_blue',
                        UpperEdgeMargin=0.1,
                        LowerEdgeMargin=0.07,
                    )}

        SouthIcons(2)={(ObjIconRed = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_red',
                        ObjIconBlue = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_blue',
                        ObjBorder = Texture2D'SM_UI.HUD.CaptureBar.ui_hud_obj_ZNG_border',
        ...
        SouthIcons(3)={(ObjIconRed = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_red',
                        ObjIconBlue = Texture2D'SM_UI.OverheadMap.ui_overheadmap_icons_ZNG_blue',
                        ObjBorder = Texture2D'SM_UI.HUD.CaptureBar.ui_hud_obj_ZNG_border',
